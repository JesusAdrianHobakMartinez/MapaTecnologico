<div class="w-full max-w-xs mx-auto">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="createDataModalLabel">Nuevo Departamento</h5>
            <button type="button" wire:click="create()" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary close-btn" wire:click="create()">Cerrar</button>
